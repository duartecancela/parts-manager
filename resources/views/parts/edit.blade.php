...
<div class="flex justify-center">
    <div class="container bg-gray-100 mx-auto p-6 rounded-lg max-w-screen-lg">
        ...
        {{-- start update form --}}
        <form method="POST" action="{{url('parts/update')}}" class="w-10/12">
            @csrf
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <select id="category" name="category" type="text" class="appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700
                        leading-tight focus:outline-none focus:bg-white focus:border-purple-500">
                        <option value="{{ $part->categoty_id }}" selected="selected">{{$part->categories->name}}</option>
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    ...
                    leading-tight focus:outline-none focus:bg-white cursor-not-allowed bg-gray-50"
                           id="stock" name="stock" type="text" value="{{ old('stock', $part->stock) }}">
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
                ...
                <div class="md:w-2/3">
                    ...
                    leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="description"
                              type="text" name="description" rows="5">{{ old('description', $part->description) }}</textarea>
                </div>
            </div>

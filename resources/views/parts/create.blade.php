...
@section('content')
    <div class="flex justify-center">
        <div class="container bg-gray-100 mx-auto p-6 rounded-lg max-w-screen-lg">
            ...
            {{-- content name --}}
            <div class="border-b-2 border-blue-200 mb-8 pb-4">
            ...
            <form class="w-10/12">
                ...
                <div class="md:w-2/3">
                    ...
                    id="name" type="text" placeholder="Introduce a part name">
                </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                    <div class="md:w-1/3">
                ...
                <div class="md:w-2/3">
                    ...
                    type="text" placeholder="Introduce a part description" rows="5"></textarea>
                </div>
                </div>
